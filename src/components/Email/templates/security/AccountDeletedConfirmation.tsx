...
export const AccountDeletedConfirmation: React.FC<AccountDeletedConfirmationProps> = ({
  ...
  return (
    <EmailLayout previewText="Your account has been deleted" title="Account Deleted">
      <Text className="text-2xl font-bold text-gray-900 mb-4">Account Deletion Confirmed</Text>
      <Text className="text-gray-700 text-base leading-relaxed mb-6">
        Hi {userName}, your account was successfully deleted on {deletionDate}.
      </Text>
      <Section className="bg-red-50 p-4 rounded-lg mb-6 border border-red-100">
        <Text className="text-red-800 m-0 leading-relaxed">
      ...
      <EmailDivider />
      <Text className="text-gray-500 text-sm">We're sorry to see you go! If you ever decide to come back, you're always welcome.</Text>
    </EmailLayout>
  );
};