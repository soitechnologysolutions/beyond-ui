...
export const IncidentReport: React.FC<IncidentReportProps> = ({
  ...
  return (
    <EmailLayout previewText="Incident Report & Post-Mortem" title="Incident Report">
      <Text className="text-2xl font-bold text-gray-900 mb-4">Post-Incident Report</Text>
      ...
      <Section className="bg-gray-50 p-6 rounded-lg mb-6 border border-gray-100">
        <Text className="text-gray-700 m-0 mb-4"><strong>Incident:</strong><br/>{incidentSummary}</Text>
        <Text className="text-gray-700 m-0 mb-4"><strong>Duration:</strong><br/>{duration}</Text>
        <Text className="text-gray-700 m-0 mb-4"><strong>Root Cause:</strong><br/>{rootCause}</Text>
        <Text className="text-gray-700 m-0"><strong>Resolution & Prevention:</strong><br/>{fixApplied}</Text>
      </Section>
      <Section className="text-center mb-6">
        <EmailButton href={statusPageLink}>View Full Status Report</EmailButton>
      </Section>
      <Text className="text-gray-700 text-base leading-relaxed">Thank you for your patience and understanding while we resolved this issue.</Text>
    </EmailLayout>
  );
};