...
export const SubscriptionCancelled: React.FC<SubscriptionCancelledProps> = ({
  ...
  return (
    <EmailLayout previewText="Your subscription has been cancelled" title="Subscription Cancelled">
      <Text className="text-2xl font-bold text-gray-900 mb-4">Subscription Cancelled</Text>
      ...
      <EmailDivider />
      <Text className="text-gray-500 text-sm">We're sorry to see you go. If you have a moment, we'd love to hear your feedback on how we can improve.</Text>
    </EmailLayout>
  );
};